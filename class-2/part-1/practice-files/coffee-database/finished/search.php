    ...
    <body>
        <div class="wrapper">
            ...
            <div class="navbar">
                ...
                <a href="search.php" class="navcurr">Search</a>
            </div>
            ...
            <div class="content">
                ...
                <form action="search_result.php" method="get">
                    ...
                    <!--Radio Selector for Roast-->
                     Roast: <input type="radio" name="roast" value="light" />Light <input type="radio" name="roast" value="medium" />Medium <input type="radio" name="roast" value="dark" />Dark <input type="radio" name="roast" value="" />Any<br />
