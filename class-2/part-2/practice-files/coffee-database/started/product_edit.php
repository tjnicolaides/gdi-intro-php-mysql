        ...
        <div class="wrapper">
            ...
            <div class="content">
                ...
                <form action="product_edit_result.php" method="get">
                    ...
                    Roast: 
                        <input type="radio" name="roast" value="light" <?php if ($roast=="light") echo "selected='selected'" ?> />Light         
                        <input type="radio" name="roast" value="medium" <?php if ($roast=="medium") echo "selected='selected'" ?> />Medium 
                        <input type="radio" name="roast" value="dark" <?php if ($roast=="dark") echo "selected='selected'" ?> />Dark 
