            ...
            <div class="content">
                ...
                <form action="product_edit_result.php" method="get">
                    ...
                    <select name="company">
                        ...
                        <option value="" <?php if ($company=="") echo "selected='selected'" ?>>
                            Choose
                        </option>
                        <?php
                      ...
                      ?>
                        ...
                        Roast: 
                            <input type="radio" name="roast" value="light" <?php if ($roast=="light") echo "checked='checked'" ?> />Light 
                            <input type="radio" name="roast" value="medium" <?php if ($roast=="medium") echo "checked='checked'" ?> />Medium 
                            <input type="radio" name="roast" value="dark" <?php if ($roast=="dark") echo "checked='checked'" ?> />Dark<br />
